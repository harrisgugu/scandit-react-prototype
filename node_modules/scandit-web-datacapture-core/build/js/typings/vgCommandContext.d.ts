...
/**
 * Adds a scaling transformation to the canvas units horizontally and vertically
 */
...
/**
 * Add a non-zero or even-odd path winding rule
 */
export interface AddPathWindingCommand {
    command: "addPathWinding";
    args: {
        winding: string;
    };
}
