...
export declare enum OverrideState {
    Auto = "auto",
    Off = "off",
    On = "on"
}
...
export declare class DataCaptureLoader {
    ...
    protected constructor(libraryLocation: string, isPreloadEngine: boolean, overrideThreadsSupport: OverrideState, overrideSimdSupport: OverrideState, loadProgressNotifier?: DataCaptureLoaderOptions["loadProgressNotifier"]);
